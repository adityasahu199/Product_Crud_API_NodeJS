...
describe('Product Controller Tests', function() {
    ...
    it('should return all products.', async() => {
        ...
        await chai.request(app).get('/api/products').send().then((res) => {
            ...
            expect(res.body[0].description).to.be.eq("good product");
            ...
            expect(res.body[0].description).to.be.eq("nice product");
            ...
            expect(res.body[0].description).to.be.eq("beautiful product");
        }).catch((err) => {
    ...
    it('should return product by name.', async() => {
        ...
        // When
        await chai.request(app).get('/api/products'+request.name).send().then((res) => {
    ...
    it('should return product by description.', async() => {
        ...
        // When
        await chai.request(app).get('/api/products'+request.description).send().then((res) => {
