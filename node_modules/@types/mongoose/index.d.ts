...
declare module "mongoose" {
  ...
  interface Model<T extends Document, QueryHelpers = {}> extends NodeJS.EventEmitter, ModelProperties {
    ...
    findByName(conditions: any, callback?: (err: any, res: T) => void): DocumentQuery<T, T> & QueryHelpers;
    findByDescription(conditions: any, callback?: (err: any, res: T) => void): DocumentQuery<T, T> & QueryHelpers;
