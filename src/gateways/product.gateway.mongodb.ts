...
export class ProductMongoGateway implements IProductGateway {
    ...
    public async findByName(name: string): Promise<IProduct> {
        return Product.findByName({name: name})
            .then((data: IProduct) => {
                return data;
            })
            .catch((error: Error) => {
    ...
    public async findByDescription(description: string): Promise<IProduct> {
        return Product.findByDescription({description: description})
            .then((data: IProduct) => {
                return data;
            })
            .catch((error: Error) => {
